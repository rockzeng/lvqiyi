        ...
        <div class="left">
            <div class="right">
                ...
                <div class="mid">
                    ...
                    <div id="info"><label><?php echo $userDetails['name'] ?>的粉丝</label></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="alpha" class="container Mcenter clearfix transitions-enabled">
                        ...
                        <div id="follow_unfollow_<?php echo $id_ref;?>" class="follow_unfollow">
                            <?php if(!isFollowAll($userFollowsValue->user_id)):?>
                                <?php if($userFollowsValue->user_id!=$this->session->userdata('login_user_id')):?>
                                 ...
                                 <?php endif?>
                            <?php else:?>
                                <a id="unfollow_btn_<?php echo $id_ref;?>" onclick="followsFn('unfollow',<?php echo $id_ref;?>);" class="Button2 Button13 WhiteButton"><strong>取消全部关注</strong><span></span></a>
                            <?php endif?>
                        </div>
            ...
            <?php else:?>
                <div class="alert_messgae">
                    <h2> <?php echo $userDetails['name'] ?>暂时没有任何粉丝</h2>
                </div>
            <?php endif?>
        </div> <!-- #alpha -->
    </div>
