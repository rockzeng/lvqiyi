                ...
                <form id="PinEdit" style="margin-top: 6px;" class="Form StaticForm" action="<?php echo site_url('board/savePin');?>" method="POST" accept-charset="utf-8">
                    ...
                    <ul>
                        ...
                        <li>
                            <label>删除</label>
                            <div class="Right">
                                <a href="<?php echo site_url('pins/confirmDelete/'.$result->board_id.'/'.$result->id);?>"  id="delete" class="Button WhiteButton Button18 deleteButton ajax" ><strong>删除收藏</strong><span></span></a>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="Submit">
                        <p>
                            <input type="submit" name="submit" value="保存" id="submit" class="Button2 Button13 WhiteButton" onClick=" return pinEditFn();"/>
                        </p>
                    </div>
                </form>
            <?php else:?>
