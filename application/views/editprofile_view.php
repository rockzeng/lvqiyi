    ...
    <div class="FixedContainer">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="Right">
                            ...
                            <span class="help_text">我们将保密！</span>
        ...
        <!--            <li>
                    ...
                    <li>
                        <label>密码</label>
                        <div class="Right">
                            <a href="<?php echo site_url('password/index');?>" class="Button WhiteButton Button18"><strong>修改密码</strong><span></span></a>
                        </div>
                    </li>
                    <!-- First Name -->
                    <li>
                        <label for="id_first_name">姓</label>
                        <div class="Right">
                    ...
                    <!-- Last Name -->
                    <li>
                        <label for="id_last_name">名</label>
                        <div class="Right">
        ...
        <!--            <li>
                    ...
                    <li class="Delete">
                        ...
                        <div class="Right">
                            <!-- href="/vishalv/delete/" -->
                            <a href="<?php echo site_url('editprofile/confirmDelete/'.$result->id);?>"  id="delete_user_account" class="Button WhiteButton Button18 ajax" name="delete_user_account"><strong>删除账户</strong><span></span></a>
                        </div>
                    </li>
                ...
                <!-- Button -->
                <div class="Submit">
                    <input type="submit" name="submit" value="保存" class="Button2 Button13 WhiteButton"/>
                </div>
