            ...
            <div class="pop_content">
                <div id="pop_content">
                    <div class="right clsFloatRight" style="float: left;width: auto;padding-top: 19px;">
                        <p>你确定删除图墙吗？图墙被删除之后将无法找回。</p>
                        <br clear="all">
                        <input id="delete_yes" type="button" name="yes" class="Button2 Button13 WhiteButton" value="是" onclick="proceed('yes')"/>
                        <input id="delete_no" type="button" name="no" class="Button2 Button13 WhiteButton" value="否" onclick="proceed('no')"/>
