                ...
                <div id="Shorts_key" class="sub_box">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="submit" class="Button2 Button13 WhiteButton" name="submit" id="settings_submit" value="保存设置" onclick="return validateSettings(<?php echo $result['id'] ? $result['id'] : 0; ?>)"/></td>
