...
<div id="Header">
	<div class="head_top">
    	<div class="head_inner">
    		<ul id="Navigation">
                <li>
                    <a class="nav link1" class="fancyboxForm" href="<?php echo site_url();?>" id="add_pin"> 主页</a>
                </li>
                <?php if($this->session->userdata('admin_login')):?>
                    <li>
                        <a class="nav link1" class="fancyboxForm" href="<?php echo site_url('administrator/logout');?>" id="add_pin"> 退出</a>
                    </li>
                <?php endif;?>
