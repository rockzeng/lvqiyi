                    ...
                    <div class="right clsFloatRight" style="float: left;width: auto;">
                        <div id="edit_user">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><label><label for="id_board">图墙</label></label></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input class="Button2 Button13 WhiteButton" type="button" name="submit" value="保存" id="pin_submit" onClick=" return pinEdit(<?php echo $result->id;?>);"/></td>
                                </tr>
                            </table>
                        </div>
                    </div>
...
function pinEdit(id)
{
    ...
    if(description=="")
    {
        $('#errordetails').html('请输入内容');
       var failed = 1;
    }
    if(source=="")
    {
        $('#errorlink').html('请输入链接地址');
        var failed = 1;
    }
    if(gift=="")
    {
