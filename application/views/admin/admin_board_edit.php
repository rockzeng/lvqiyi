                    ...
                    <div class="right clsFloatRight" style="float: left;width: auto;">
                        <div id="edit_user">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><label><label for="category">分类</label></label></td>
                                    <td>
                                ...
                                <tr>
                                    <td id="deleting" style="display: none;">保存。。。<div id="loading"></div></td>
                                    <td><input type="button" class="Button2 Button13 WhiteButton" name="submit" value="保存" id="edit_submit" onClick=" return categoryEdit(<?php echo $result->id;?>);"/></td>
                                </tr>
                            </table>
                        </div>
                    </div>
