                                          ...
                                          <?php endif;?>
                                              ...
                                              <div class="latest-updates_content">
                                                ...
                                                <div class="latest-upd-matter-box">
                                                    ...
                                                    <p class="latest-upd-post">发表于<span class="latest-upd-date"><?php echo $activityListValue->activity_timestamp;?></span></p>
                                                </div>
                                            </div>
                                          </a>
                                    </li>
            ...
            <div class="sortboard_box_right">
                ...
                <div class="sortboard_right-corn">
                    <ul class="sortboard-button">
                        <?php if($this->session->userdata('login_user_id')==$id):?>
                            <li><div class="sortboard-blue-button"><a href="<?php echo site_url('activity/latestFeeds/'.$id)?>">好友更新</a></div></li>
                            <li><span class="arrow"></span></li>
                         <?php endif;?>
                        <?php $userDetails = userDetails($id)?>
                        <?php $id_ref =$id;?>
                         <?php if($this->session->userdata('login_user_id')==$id):?>
                            <li id="rearrangeButton"><div class="sortboard-blue-button"><a  href="#" onclick="showSort();">图墙分类</a></div></li>
                            <li id="button" style="display:none;margin-top: 0px;"><div class="sortboard-blue-button"><a  href="#" onclick="saveSort();">保存分类</a></div></li>
                            <li><span class="arrow"></span></li>
                         <?php else:?>
                            <li><span class="arrow"></span></li>
                            <?php if(!isFollowAll($id)):?>
                                <li id="follow_btn_<?php echo $id_ref;?>"><div class="sortboard-blue-button"><a onclick="followFn('follow',<?php echo $id_ref;?>);">全部关注</a></div></li>
                            ...
                            <?php else:?>
                                <li id="unfollow_btn_<?php echo $id_ref;?>"><div class="sortboard-blue-button"><a onclick="followFn('unfollow',<?php echo $id_ref;?>);">取消全部关注</a></div></li>
                                <li id="loader" style="display:none;"><div class="sortboard-blue-loader"><img src="<?php echo site_url();?>/application/assets/images/admin/loading.gif"</div></li>
                             <?php endif?>
                             <li id="ajax_follow_btn_<?php echo $id_ref;?>" style="display: none;"><div class="sortboard-blue-button"><a onclick="followFn('follow',<?php echo $id_ref;?>);">全部关注</a></div></li>
                             <li id="ajax_unfollow_btn_<?php echo $id_ref;?>" style="display: none;"><div class="sortboard-blue-button"><a onclick="followFn('unfollow',<?php echo $id_ref;?>);">取消全部关注</a></div></li>
                             <li id="loader" style="display:none;"><div class="sortboard-blue-loader"><img src="<?php echo site_url();?>/application/assets/images/admin/loading.gif"</div></li>
                             <li><span class="arrow"></span></li>
                         <?php endif;?>

                        <li><div class="sortboard-blue-button"><a  href="<?php echo site_url('follow/followers/'.$id);?>" title="关注<?php echo $userDetails['name'];?>的人"><strong id="followers_count_<?php echo $id_ref;?>"><?php echo getUserFollowersCount($id);?></strong> 粉丝</a></div></li>
                        <li><span class="arrow"></span></li>
                        <li><div class="sortboard-blue-button"><a  href="<?php echo site_url('follow/following/'.$id);?>" title="<?php echo $userDetails['name'];?>关注的人"><strong id="following_count_<?php echo $id_ref;?>"><?php echo getUserFollowingCount($id);?></strong> 关注</a></div></li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <div class="pin_inner_container">
                                            ...
                                            <div class="edit_button">
                                                ...
                                                <?php if($this->session->userdata('login_user_id')==$value->user_id):?>
                                                    <a href="<?php echo site_url('board/edit/'.$value->id)?>">编辑</a>
                                                 <?php else:?>
                                                    <?php $id_ref =$value->id;?>
                                                        <div id="follow_unfollow_<?php echo $id_ref;?>">
                                                        <?php if(!isFollow($this->session->userdata('login_user_id'),$value->id)):?>
                                                            <a id="follow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $value->user_id;?>);" class="Button13 Button RedButton followuserbutton" style="cursor: pointer;"><strong >关注</strong><span></span></a>
                                                        <?php else:?>
                                                            <a id="unfollow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $value->user_id;?>);" class="Button13 Button RedButton followuserbutton" style="cursor: pointer;"><strong>取消关注</strong><span></span></a>
                                                        <?php endif?>
                                                        </div>
                                                        <span id="ajax_follow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;"><a onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $value->user_id;?>);" class="Button13 Button RedButton followuserbutton"><strong>关注</strong><span></span></a></span>
                                                        <span id="ajax_unfollow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;"><a onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $value->user_id;?>);" class="Button13 Button RedButton followuserbutton"><strong>取消关注</strong><span></span></a></span>
                                                 <?php endif;?>
                                            </div>
                                        </div>
                                    </div>
