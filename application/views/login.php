                                ...
                                <div class="login_box">
                                    ...
                                    <form class="login_normal" action="<?php echo site_url(); ?>login/normal" method="POST" accept-charset="utf-8">
                                        <ul class="login_form">
                                            ...
                                            <li>
                                                <a href="<?php echo site_url('invite/entry'); ?>" class="Button2 Button13 WhiteButton"><strong>注册</strong><span></span></a>
                                            </li>
                                        ...
                                        <div class="non_inputs">
                                            <input type="submit" name="submit" value="登录" id="login" class="Button2 Button13 WhiteButton"/>
                                            <a id="resetPass" class="colorless" href="#" onclick="forgetPass('show')">忘记密码？</a>
                                            <a href="#" class="Button2 Button13 WhiteButton" id="reset" onclick="forgetPass('save')" style="display: none"><strong>重置密码</strong><span></span></a>
                                            <a id="back" style="display: none;" href="#" class="colorless" onclick="forgetPass('back')">返回登录？</a>
            ...
            if(email=='')
            {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#loading').hide()
                        $('#reset_message').html('我们已经将重置的链接发送到你的邮箱，请登录邮箱确认！')
                    }
                });
            }
        }
