...
<div class="banner_bg"><!-- starting bganner bg -->
    <div class="container"><!-- starting container -->
        <div class="banner-white-bg">
            ...
            <div class="profile_image"><img src="<?php echo $userDetails['image']; ?>?type=large" alt="<?php echo $userDetails['name']; ?>的个人头像" width="183" height="189" /></div>
            </div>
            <div class="banner_bluebg_right">
                <div class="profile-details-wrap">
                    ...
                    <div class="prof-details-right-wrap">
                        <div class="pinit_button">
                            ...
                            <a onclick="alert('把我拖到书签栏'); return false;" href="javascript:(function(){var%20s%20=%20document.createElement('script');s.src%20=%20'<?php echo site_url()?>application/scripts/extractor.js';document.body.appendChild(s);})();">收藏</a>
                ...
                <div class="profile-details-buttonbox">
                    ...
                    <ul class="pro-details-bottons">
                        <li><div class="pro-blue-button"><a href="<?php echo site_url('/board/boardView/'.$id)?>"><?php echo $boardCount;?> 图墙</a></div></li>
                        <li><div class="pro-blue-button"><a href="<?php echo site_url('/pins/index/'.$id)?>"><?php echo $count;?> 收藏</a></div></li>
                        <?php $likeCount = pinLikes($userDetails['userId']);?>
                        <li><div class="pro-blue-button"><a href="<?php echo site_url('/like/index/'.$id)?>"><?php echo $likeCount;?> 喜欢</a></div></li>
                        <?php $activitycount = activityCount($id); ?>
                        <li><div class="pro-blue-button"><a href="<?php echo site_url('/activity/index/'.$id)?>"><?php echo $activitycount;?> 动态</a></div></li>
                        
                        <?php if($this->session->userdata('login_user_id')==$id):?>
                        <li><div class="edit-prof-button"><span class="edit-prof-icon"></span><a href="<?php echo site_url('editprofile')?>">个人设置</a></div></li>
                        <?php endif;?>
                    </ul>
