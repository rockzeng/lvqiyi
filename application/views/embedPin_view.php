            ...
            <div class="pop_content">
                <div class="Pop_Up_Blk" id="Embed">
                    <div class="static_form">
                        <div class="pop_content">
                            <ul>
                                <li><input type="text" id="height" value="200" maxlength="3" name="height"  onblur="changeAtts(this.value,'height')"><span> px - 图片高</span></li>
                                <li><input type="text" id="width" value="297" maxlength="3" name="width" onblur="changeAtts(this.value,'width')"><span> px - 图片宽</span></li>
