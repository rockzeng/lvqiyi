<body id="profile">
    <div id="Header">
        <div class="FixedContainer HeaderContainer">
            ...
            <ul id="Navigation">
                <li><a href="#" class="nav" onclick="Modal.show('Add'); return false">添加<span class="PlusIcon"></span></a></li>
                <li>
        ...
        <div class="FixedContainer row clearfix">
            <div class="info">
                ...
                <a href="http://media-cache2.pinterest.com/avatars/vishalv_1331624317_o.jpg" class="ProfileImage" target="_blank">
                    <img src="http://media-cache2.pinterest.com/avatars/vishalv_1331624317_o.jpg" alt=" Vishal Vijayan的个人头像" />
                </a>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="/chicabellacc/?d">
                            <img src="http://media-cache8.pinterest.com/avatars/chicabellacc_1328621694.jpg" alt="Natasha Moroney的个人头像" />
    ...
    <div id="ContextBar" class="container sticky">
        <div class="FixedContainer">
            ...
            <ul class="follow">
                ...
                <li><a href="/vishalv/followers/"><strong>2</strong> 粉丝</a></li>
                <li><a href="/vishalv/following/"><strong>12</strong> 关注</a></li>
            </ul>


                <div class="action">

                    <a class="Button13 Button WhiteButton Left Tab" href="/settings/"><strong>个人设置</strong><span></span></a>
                    ...
                    <a id="RearrangeCancel" class="close" tooltip="<strong>Cancel</strong>" href="#">关闭</a>
