        ...
        $.ajax({
	        ...
	        success: function(data){
                ...
                if(commentinfo[1]!=0)
                {
                    ...
                    $("div[id=comments_box_"+pinid+"]:last").append("<div class='convo_blk comments width_class' id='comment_id_"+data[1]+"'><a class='convo_img' href='#'><img src="+logImage+" height='50' width='50'/></a><a href="+baseUrl+"'user/index/'"+logId+"><strong>"+commentinfo[0]+" </strong></a>"+commentinfo[1]+"<a style='cursor: pointer;float:right;margin-right:5px;'  onclick='deleteComment("+data[1]+")' title='删除评论' class='DeleteComment floatRight tipsyHover'>X</a></div> ");
            }
            }
        })
                    ...
                    <div class="pin_inner_container">
                        ...
                        <div class="edit_button">
                            <?php if($this->session->userdata('login_user_id')==$pinDetails->user_id):?>
                                    <a href="<?php echo site_url('board/edit/'.$pinDetails->board_id)?>">编辑</a>
                             <?php else:?>
                                <?php $id_ref =$pinDetails->board_id;?>
                                    ...
                                    <?php if(!isFollow($this->session->userdata('login_user_id'),$pinDetails->board_id)):?>
                                        <a id="follow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" class="Button13 Button RedButton followuserbutton" style="cursor: pointer;"><strong >关注</strong><span></span></a>
                                    <?php else:?>
                                        <a id="unfollow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" class="Button13 Button RedButton followuserbutton" style="cursor: pointer;"><strong>取消关注</strong><span></span></a>
                                    <?php endif?>
                                    </div>

                                    <span id="ajax_follow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;"><a onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" class="Button13 Button RedButton followuserbutton"><strong>关注</strong><span></span></a></span>
                                    <span id="ajax_unfollow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;"><a onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" class="Button13 Button RedButton followuserbutton"><strong>取消关注</strong><span></span></a></span>
                             <?php endif;?>
                        </div>
                    </div>
                </div>
                ...
                <div class="inside-pinsours-board">
                    <div class="inside-pinsours_container">
                            ...
                            <div class="inside-pinname-container">
                                 ...
                                 <?php else:?>
                                    <a ><h3><a  class="colorless">其他的收藏</a></h3></a>
                                <?php endif;?>
                            </div>
            ...
            <div class="pin-right-wrap">
                <div class="pin-prof-box">
                    ...
                    <div class="pin-prof-name-box">
                        ...
                        <p>收藏于 <?php echo $pinDetails->time;?></p>
                ...
                <div class="PinActionButtons-box">
                    ...
                    <div class="PinActionName-right">
                        <?php if($pinDetails->source_url!=""):?>
                            <p id="PinSource" class="colorlight">来自 <a href="<?php echo $pinDetails->source_url;?>" target="_blank" ><?php echo $source;?></a></p>
                        <?php else:?>
                            <?php $userDetails = userDetails($pinDetails->user_id);?>
                            <p id="PinSource" class="colorlight"> <a>由 <?php echo $userDetails['name'];?> 上传</a></p>
                        <?php endif;?>
                    </div>
...
<!--                <div class="">
                    <div id="PinLikes" class="PinActivity hidden">
                        ...
                        <h4 id="likecount"><?php echo $pinLikeCount;?> 喜欢</h4>
                    </div>

                    <div id="PinRepins" class="PinActivity hidden">
                        <?php //$pinRepinCount = getRepinCount('from_pin_id',$pinDetails->id)?>
                        <h4 id="repin_count_<?php //echo $pinDetails->id;?>"><?php //echo $pinRepinCount;?> 收藏</h4>
                    </div>
                </div>-->
                ...
                <div class="pin_item" style="width: 610px;background:none;border: none;">
                        ...
                        <?php endif?>
                         ...
                         <a class="act_comment" id="<?php echo $commentId?>" href="javascript:;" onClick="addComment(<?php echo $pinId ;?>,'comment')" ><span>评论</span></a>
                         </div>
