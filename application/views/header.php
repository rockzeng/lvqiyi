...
<head>
    ...
    <?php endif;?>
    <title><?php echo (isset($title))?$title:'lvqiyi.com_绿奇异';?></title>
    ...
    <?php if((isset($pinId))&&(isset($boardId))):?>
        ...
        <?php if(!empty($pinDetails)):?>
            ...
            <meta property="og:site_name" content="lvqiyi.com_绿奇异"/>
        ...
        <?php endif;?>
        <?php else:?>
             <meta property="og:title" content="lvqiyi.com_绿奇异"/>
            ...
            <meta property="og:type" content="album"/>
            <meta property="og:url" content="<?php echo current_url();?>"/>
            <meta property="og:description" content="绿奇异"/>
    <?php endif;?>
                ...
                <div class="header_box">
                    ...
                    <div class="header_links-box" <?php echo $style;?>>
                        <ul class="nav">
                            ...
                            <?php if(!$this->session->userdata('login_user_id')):?>
                                <li>
                                    <a href="<?php echo site_url('welcome/index')?>">主页</a></li>
                                <li>
                            ...
                            <li style="width: 60px;">
                                <a class="nav-add" href="#">新建</a>
                                <ul>
                                    <li><a href="<?php echo site_url('board/add')?>" class="ajax" >新建图墙</a></li>
                                    <li><a href="<?php echo site_url('pins/addPins')?>" class="ajax" >收藏网页图片</a></li>
                                    <li class="beforeDivider"><a href="<?php echo site_url('pins/uploadPins')?>" class="ajax" >上传本地图片</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="float-right">
                                <span class="profile-thumb-nav">
                                    ...
                                    ?>
                                    <a href="<?php echo site_url('user/index/'.$loggedUserDetails['userId']);?>"><img src="<?php echo $image_url; ?>" title="<?php echo $loggedUserDetails['name']; ?>的个人头像" width="24" height="24" />
                                    </a>
                                </span>
                            </li>
...
<!--                                    <li class="beforeDivider"><a href="<?php //echo site_url()?>invite">Find Friends</a></li>-->
                                    <li class="divider"><a href="<?php echo site_url('user/index/'.$loggedUserDetails['userId']);?>">我的图墙</a></li>

                                    <li><a href="<?php echo site_url()?>pins">我的收藏</a></li>
                                    <li><a href="<?php echo site_url()?>like">我喜欢的收藏</a></li>
                                    <li class="divider"><a href="<?php echo site_url()?>editprofile/">个人设置</a></li>
