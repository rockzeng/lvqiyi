...
<div class="middle-banner_bg"><!-- staing middlebanner -->
        ...
        <div class="left">
            <div class="right">
                <div class="mid">
                    ...
                    <div id="info" >
                        <label>图墙： <?php echo $boardDetails->board_name; ?></label>
                    </div>
                    <div id="info" style="margin-left: 127px;font-size: 16px;">
                        <?php if ($this->session->userdata('login_user_id') == $boardDetails->user_id): ?>
                            <a class="Button2 Button13 WhiteButton" href="<?php echo site_url('board/edit/' . $boardId) ?>"><strong>编辑图墙</strong><span></span></a>
                        <?php else: ?>
                            <?php if (isFollow($this->session->userdata('login_user_id'), $boardDetails->id)): ?>
                                <a href="<?php echo site_url('follow/saveUnFollow/' . $boardDetails->user_id . '/' . $boardDetails->id) ?>" class="Button2 Button13 WhiteButton"><strong>取消关注</strong><span></span></a>
                            <?php else: ?>
                                <a href="<?php echo site_url('follow/saveFollow/' . $boardDetails->user_id . '/' . $boardDetails->id) ?>" class="Button2 Button13 WhiteButton"><strong>关注</strong><span></span></a>
                            <?php endif ?>
                        <?php endif ?>
                    </div>
                    <div id="info" style="float: right;font-size: 16px;">
                        <div id="BoardStats"><strong><a href="<?php echo site_url(); ?>/board/followers/<?php echo $boardId; ?>"><?php echo countBoardFollowers($boardDetails->id) ?>  <span>粉丝</span></a></strong>, <strong><?php echo count($result); ?></strong> 收藏 </div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="Container">
                    ...
                    <div class="action">
                        ...
                        <span id="like_action<?php echo $value->id; ?>">
                            <?php if ($value->user_id == $this->session->userdata('login_user_id')): ?>
                                <a href="<?php echo site_url('board/pinEdit/' . $boardId . '/' . $value->id) ?>" class="act_repin"><span>编辑</span></a>
                            <?php else: ?>
                                <?php if (!isLiked($value->id, $this->session->userdata('login_user_id'))): ?>
                                    <a class="act_like" id="<?php echo $likeId ?>" href="javascript:;"  onClick="doAction(<?php echo $like; ?>,<?php echo $value->id; ?>,'like')"><span>喜欢</span></a>
                                <?php else: ?>
                                    <a class="act_unlike" id="<?php echo $unlikeId ?>" href="javascript:;"   onClick="doAction(<?php echo $like; ?>,<?php echo $value->id; ?>,'unlike')"><span>已喜欢</span></a>
                                <?php endif ?>
                            <?php endif ?>
                        </span>
                        ...
                        <a class="fancyboxForm act_repin ajax" href="<?php echo site_url('repin/load/' . $value->id) ?>">收藏</a>
        ...
        <!--                <a class="act_comment" id="<?php //echo $commentId  ?>" href="javascript:;" onClick="addComment(<?php //echo $value->id;  ?>,'comment')" ><span>Comment</span></a>
                        ...
                        <a class="act_uncomment" id="<?php echo $uncommentId ?>" href="javascript:void(0);" ><span>取消评论</span></a>
                    </div>
                    ...
                    <div class="comm_des">
                        ...
                        <p class="comm_like">
                            ...
                            <span id="<?php echo $likeCountId; ?>"><?php echo getPinLikeCount($value->id); ?> 喜欢</span>
                    ...
                    <div class="convo_blk attribution">
                        ...
                        <p>
                            ...
                            通过 <a target="_blank" href="<?php echo $value->source_url; ?>"><?php echo $source; ?></a>
                            <?php endif; ?>
