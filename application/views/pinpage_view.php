...
<div class="inside_midd_wrap" >
    <div class="inside_left_items_box" id="inside_left_items_box" style="height: auto;">
            <div class="insde_pin_topbox">
                ...
                <span class="pin_date">
                    <p>收藏于 <?php echo $pinDetails->time;?> 来自 <a href="<?php echo site_url('pins/source/'.$encode_source);?>"><?php echo $sourceName;?></a></p>
                </span>
                <?php if(!$this->session->userdata('login_user_id')):?>
                    <span class="popup_login">
                        <span class="buttonLogin">
                            <a style="color:#ffffff;" href="<?php echo site_url('login/handleLogin/?next=board/pins/'.$boardId.'/'.$pinId);?>">登录</a></span>
                        </span>
                 <?php else:?>
                        <span class="popup_login">
                        <span class="buttonLogin">
                             <?php if($this->session->userdata('login_user_id')==$pinDetails->user_id):?>
                              <a style="color:#ffffff;" href="<?php echo site_url('board/pinEdit/'.$boardId.'/'.$pinId);?>">编辑</a>
                             <?php else:?>
                                <?php $id_ref =$pinDetails->board_id;?>
                                    ...
                                    <?php if(!isFollow($this->session->userdata('login_user_id'),$pinDetails->board_id)):?>
                                        <a id="follow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" style="cursor: pointer;color:#ffffff;"><strong >关注</strong><span></span></a>
                                    <?php else:?>
                                        <a id="unfollow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);"  style="cursor: pointer;color:#ffffff;"><strong>取消关注</strong><span></span></a>
                                    <?php endif?>
                                    </div>

                              <span id="ajax_follow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;color:#ffffff;"><a onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" ><strong style="color:#ffffff;">关注</strong><span></span></a></span>
                              <span id="ajax_unfollow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;color:#ffffff;"><a onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" ><strong style="color:#ffffff;">取消关注</strong><span></span></a></span>
                             <?php endif;?>
                        </span>
                        </span>
                <?php endif;?>
...
<!--                            <li class="edit-button">
                        ...
                        <li><a href="#" onclick ="loadEmail(<?php echo $pinDetails->id;?>,<?php echo $pinDetails->board_id;?>,'email' )" id="EmailShare" class="Button2 Button13 WhiteButton"><strong>@ 分享给朋友</strong><span></span></a></li>
                        <li><a href="#" onclick ="loadEmail(<?php echo $pinDetails->id;?>,<?php echo $pinDetails->board_id;?>,'close' )" id="CloseEmailShare" class="Button2 Button13 WhiteButton" style="display:none;"><strong>@ 返回</strong><span></span></a></li>

                        <li><a href="#" onclick ="loadReport(<?php echo $pinDetails->id;?>,<?php echo $pinDetails->board_id;?>,'report' )" id="PinReport" class="Button2 Button13 WhiteButton"><strong>&#9872; 举报</strong><span></span></a></li>
                        <li><a href="#" onclick ="loadReport(<?php echo $pinDetails->id;?>,<?php echo $pinDetails->board_id;?>,'close' )"  id="ClosePinReport" class="Button2 Button13 WhiteButton" style="display:none;"><strong>&#9872; 返回</strong><span></span></a></li>

                        <li><a href="#" onclick ="loadEmbed(<?php echo $pinDetails->id;?>,<?php echo $pinDetails->board_id;?>,'embed' )" id="PinEmbed" class="Button2 Button13 WhiteButton"><strong>&lt;&gt; 嵌入</strong><span></span></a></li>
                        <li><a href="#" onclick ="loadEmbed(<?php echo $pinDetails->id;?>,<?php echo $pinDetails->board_id;?>,'close' )" id="ClosePinEmbed" class="Button2 Button13 WhiteButton" style="display:none;"><strong>&lt;&gt;返回</strong><span></span></a></li>
                    </ul>
                ...
                <div class="pin_item" style="width: 610px;background:none;border: none;">
                        ...
                        <!-- Comment List -->
                            <div class="convo_blk comments width_class individual" id="comment_id_<?php echo $cmt->id;?>">
                                ...
                                <?php if($this->session->userdata('login_user_id')):?>
                                    ...
                                    <a data="<?php echo $cmt->id;?>" id="<?php echo "delete_".$cmt->id ?>" style="cursor: pointer;float: right;margin-right: 5px;"  onclick="deleteComment(<?php echo $cmt->id;?>)" title="删除评论" class="DeleteComment floatRight tipsyHover">X</a>
                                    <?php endif?>
                                <?php endif?>
                    ...
                    <?php endif?>
                     ...
                     <?php $commentId = 'comment-individual-'.$pinId?>
                      <?php if($this->session->userdata('login_user_id')):?>
                         <a class="act_comment" id="<?php echo $commentId?>" href="javascript:;" onClick="addComment(<?php echo $pinDetails->id ;?>,'comment')" ><span>评论</span></a>
                     <?php endif?>
                     </div>
                    </div>
            ...
            <?php endif;?>
                ...
                <span class="inside_artlike_box_text">收藏在图墙</span>
                <div class="clear"></div>
                ...
                <div class="pinned_box_right_wrap">
                    <div class="pinned_member_box" style="height: 100px">
                        <span class="inside_artlike_box_text">收藏来自</span>
                ...
                <div class="all_repinsbox" style="min-height: 59px">
                    ...
                    <h3><?php echo $pinRepinCount;?> 收藏 </h3>
                            ...
                            <?php foreach ($repinUsers as $key => $value): ?>
                                ...
                                <li id="addrepin_<?php echo $value->repin_user_id;?>">
                                    <div class="repin_itembox">
                                        ...
                                        <div class="onto_div">
                                            <p><a href="<?php echo site_url('user/index/'.$userDetails['userId']);?>"><?php echo $userDetails['name'];?></a> 收藏在 <a href="<?php echo site_url('board/index/'.$repinBoardDetails->id);?>"><?php echo $repinBoardDetails->board_name;?></a></p>
                                        </div>
                                    </div>
                                </li>
                            <?php endforeach;?>
                ...
                <div class="inside_like_bx" style="min-height: 100px">
                    ...
                    <h3 id="likecount"><?php echo $likeUsers?count($likeUsers):'0';?> 喜欢 </h3>
        ...
        $.ajax({
	        ...
	        success: function(data){
                ...
                if(commentinfo[1]!=0)
                {
                    ...
                    $("#comment_count_"+pinid).html(data[0]+" 评论");
                    $(".enter_comm").hide();
                    $("#count_comment_"+pinid).empty();
                    $("#count_comment_"+pinid).html("<a href=http://products.cogzidel.com/pinterest-clone/con_home/viewpin/"+pinid+">All "+commentinfo[4]+" 评论。。。</a>");
                    ...
                    $("div[id=comments_box_"+pinid+"]:last").append("<div class='convo_blk comments width_class individual' id='comment_id_"+data[1]+"'><a class='convo_img individual' href='#'><img src="+logImage+" height='50px' width='50px'/></a><a href="+baseUrl+"'user/index/'"+logId+"><strong>"+commentinfo[0]+" </strong></a>"+commentinfo[1]+"<a style='cursor: pointer;float:right;margin-right:5px;'  onclick='deleteComment("+data[1]+")' title='删除评论' class='DeleteComment floatRight tipsyHover'>X</a></div> ");
                    colorboxResize();
            }
