                        ...
                        <div class="action">
                            ...
                            <span id="like_action<?php echo $sourcePinValue->id; ?>">
                                <?php if ($sourcePinValue->user_id == $this->session->userdata('login_user_id')): ?>
                                    <a href="<?php echo site_url('board/pinEdit/' . $sourcePinValue->board_id . '/' . $sourcePinValue->id) ?>" class="act_repin"><span>编辑</span></a>
                                <?php else: ?>

                                    <?php if (!isLiked($sourcePinValue->id, $this->session->userdata('login_user_id'))): ?>
                                        <a class="act_like" id="<?php echo $likeId ?>" href="javascript:;"  onClick="doAction(<?php echo $like; ?>,<?php echo $sourcePinValue->id; ?>,'like')"><span>喜欢</span></a>
                                    <?php else: ?>
                                        <a class="act_unlike" id="<?php echo $unlikeId ?>" href="javascript:;"   onClick="doAction(<?php echo $like; ?>,<?php echo $sourcePinValue->id; ?>,'unlike')"><span>已喜欢</span></a>
                                    <?php endif ?>
                                <?php endif ?>
                            </span>
                            ...
                            <a class="fancyboxForm act_repin ajax" href="<?php echo site_url('repin/load/' . $sourcePinValue->id) ?>">收藏</a>
        ...
        <!--                        <a class="act_comment" id="<?php //echo $commentId  ?>" href="javascript:;" onClick="addComment(<?php //echo $sourcePinValue->id;  ?>,'comment')" ><span>Comment</span></a>
                        ...
                        <div class="comm_des">
                            ...
                            <p class="comm_like">
                                ...
                                <span id="<?php echo $likeCountId; ?>"><?php echo getPinLikeCount($sourcePinValue->id); ?> 喜欢</span>
                        ...
                        <div class="convo_blk attribution">
                            ...
                            <p>
                                ...
                                <?php if ($sourcePinValue->source_url != ""): ?>
                                    通过 <a target="_blank" href="<?php echo $sourcePinValue->source_url; ?>"><?php echo $source; ?></a>
                                <?php endif; ?>
