    ...
    <input  name="ajax_flag" id="ajax_flag" type="hidden"/>
                    ...
                    <input  name="current_img_src" id="current_img_src" type="hidden"/>  
                        <ul class="upload_pin_ul">
                             <li>
                                <label>图片地址：</label>
                                <input type="text" name="link" id="link" value="" class="" style="float:left"/><input type="button" name="button" id="findImage" value="查找图片" class="Button2 Button13 WhiteButton" style="float:left;margin-left: 5px;"/>
                            ...
                            <li id="save_btn">
                               <input type="submit" name="button" id="submit" value="保存" class="Button2 Button13 WhiteButton" style="float:left"/>
                            </li>
                            </span>
...
function validateUpload()
{
    ...
    if(link=="")
    {
        $('#error_link').html('请输入图片链接地址！');
        failed = 1;
    }
    if(description=="")
    {
        $('#error_description').html('请填写图片描述！');
        failed = 1;
    }
