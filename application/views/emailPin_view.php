...
<div style="border-width: 10px; width: 580px; height: auto;" id="fancybox-content">
    <div style="width: auto; height: auto; overflow: auto; position: relative;">
        <div id="Repin_Pop" class="Pop_Up_Blk">
            <h2 id="h2_heading">Email分享给朋友</h2>
                    ...
                    <div class="right clsFloatRight" style="float: left;padding: 20px;width: 300px;">
                        <form  method="post" class="Form FancyForm" id="emailForm">
                            <ul>
                                <li>
                                    <label></label>
                                    <input type="text" id="name" name="name" maxlength="180" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" value="输入名称" style="color: #D7D7D7;"/>
                                    <span class="fff"></span>
                                    <span class="helper red"></span>
                                </li>
                                <li>
                                    <label></label>
                                    <input type="text" id="email" name="email" maxlength="180" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" value="输入Email" style="color: #D7D7D7;"/>
                                    <span class="fff"></span>
                                    <span class="helper red"></span>
                                </li>
                                <li class="optional">
                                    <label></label>
                                    <textarea id="MessageBody"  name="MessageBody" maxlength="180" style="height:100px;color:#D7D7D7;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;">留言</textarea>
                                    <span class="fff"></span>
                                </li>
                            ...
                            <div><a href="#" class="Button2 Button13 WhiteButton" data-form="EmailModal" onClick="emailFn()"><strong>发送</strong><span></span></a></div>
                            <div id="error"></div>
                        </form>
                    </div>
                    <div class="clear"></div>
