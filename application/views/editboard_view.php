        ...
        <div class="FixedContainer">
            <form id="BoardEdit" class="Form StaticForm"  method="post" accept-charset="utf-8">
                <div class="editprofile_insidebox">
                    <h3>编辑图墙 / <a href="<?php echo site_url('board/index/'.$boardId);?>"><?php echo $boardDetails->board_name;?></a></h3>
                    <ul>
                        <!-- Board Title -->
                        ...
                        <li class="Delete">
                            <label>删除</label>
                            <a class="Button WhiteButton Button18 ajax" style="float:left;" href="<?php echo site_url('board/confirmDelete/'.$boardDetails->id);?>"  id="delete_confirm" ><strong>删除图墙</strong><span></span></a>
                        </li>
                        <li>
                            <div style="float: left;">
                                <input type="button" name="submit" id="saveBoard_button" value="保存" onclick="return editBoard()" class="Button2 Button13 WhiteButton"/>
                            </div>
