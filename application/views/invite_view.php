...
<head>
    ...
    <?php if((isset($pinId))&&(isset($boardId))):?>
        ...
        <?php if(!empty($pinDetails)):?>
            ...
            <meta property="og:site_name" content="绿奇异"/>
        ...
        <?php endif;?>
        <?php else:?>
             <meta property="og:title" content="绿奇异"/>
    ...
    function invite()
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data){
                    $("#loading").hide();
                    $('#message_added').html("邀请成功！") ;
                    $('.error').html("")
                    document.getElementById('invite_form').reset()
                 }
                else
                  $('#message_added').html("发生错误！") ;
...
<body>
    ...
    <div class="outer">
        ...
        <!--                    <a id="query_button" href="#" class="lg"><img src="https://a248.e.akamai.net/passets.pinterest.com.s3.amazonaws.com/images/search.gif" alt="" /></a>-->
                            <input name="q" type="text" class="form-field-input" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" value="搜索...."/>
                    ...
                    <?php if(!$this->session->userdata('login_user_id')):?>
                        <span class="buttonLogin">
                            <a href="<?php echo site_url();?>login/handleLogin">登录</a>
                        </span>
                    <?php endif;?>
                    ...
                    <div class="header_links-box" <?php echo $style;?>>
                        <ul class="nav">
                            ...
                            <?php if(!$this->session->userdata('login_user_id')):?>
                                <li>
                                    <a href="<?php echo site_url('welcome/index')?>">最新</a></li>
                                <li>
                                    <a href="<?php echo site_url('welcome/mostLiked')?>">流行</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('welcome/mostRepinned')?>">热门收藏</a>
                                </li>
                             <?php endif;?>
                            ...
                            <?php if($this->session->userdata('login_user_id')):?>
                                <li>
                                    <a class="nav-about" href="<?php echo site_url('welcome/index')?>">主页</a>
                                    <ul>
                                        <li>
                                            <a href="<?php echo site_url('welcome/mostLiked')?>">流行</a>
                                        </li>
                                ...
                                <li>
                                    <a href="<?php echo site_url('pins/videos')?>">视频</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('gift/index/0/100')?>">商品</a>
                                    <ul>
                            ...
                            <li>
                                <a class="nav-add" href="#">添加</a>
                                <ul>
                                    <li><a href="<?php echo site_url('board/add')?>" class="ajax" >新建图墙</a></li>
                                    <li class="beforeDivider"><a href="<?php echo site_url('pins/uploadPins')?>" class="ajax" >上传图片</a></li>
                                </ul>
                            </li>
...
<!--                        <li>
                            ...
                            <li class="float-right">
                                <span class="profile-thumb-nav">
                                    <a href="<?php echo site_url('user/index/'.$loggedUserDetails['userId']);?>"><img src="<?php echo $loggedUserDetails['image']; ?>?type=large" alt="<?php echo $loggedUserDetails['name']; ?>的个人头像" width="24" height="24" />
                                    </a>
                                </span>
                            </li>
...
<!--                                    <li class="beforeDivider"><a href="<?php //echo site_url()?>invite">Find Friends</a></li>-->
                                    <li class="divider"><a href="<?php echo site_url('user/index/'.$loggedUserDetails['userId']);?>">图墙</a></li>

                                    <li><a href="<?php echo site_url()?>pins">收藏</a></li>
                                    <li><a href="<?php echo site_url()?>like">喜欢</a></li>
                                    <li class="divider"><a href="<?php echo site_url()?>editprofile/">设置</a></li>
