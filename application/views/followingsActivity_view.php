        ...
        <div class="left">
            <div class="right">
                <div class="mid">
                    ...
                    <div id="info"><label>好友<?php echo $userDetails['name'] ?>最新的更新</label></div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <?php if (($activityValue)): ?>
                            ...
                            <div class="pin_item">
                                ...
                                <div class="action">
                                    ...
                                    <span id="like_action<?php echo $activityValue->id; ?>">
                                        ...
                                        <?php else: ?>
                                            <?php if (!isLiked($activityValue->id, $this->session->userdata('login_user_id'))): ?>
                                                <a class="act_like" id="<?php echo $likeId ?>" href="javascript:;"  onClick="doAction(<?php echo $like; ?>,<?php echo $activityValue->id; ?>,'like')"><span>喜欢</span></a>
                                            <?php else: ?>
                                                <a class="act_unlike" id="<?php echo $unlikeId ?>" href="javascript:;"   onClick="doAction(<?php echo $like; ?>,<?php echo $activityValue->id; ?>,'unlike')"><span>已喜欢</span></a>
                                            <?php endif ?>
                                        <?php endif ?>
                                    </span>
                                    ...
                                    <a class="fancyboxForm act_repin ajax" href="<?php echo site_url('repin/load/' . $activityValue->id) ?>">收藏</a>
                                ...
                                <div class="comm_des">
                                    ...
                                    <p class="comm_like">
                                        ...
                                        <span id="<?php echo $likeCountId; ?>"><?php echo getPinLikeCount($activityValue->id); ?> 喜欢</span>
                                ...
                                <div class="convo_blk attribution">
                                    ...
                                    <p>
                                        ...
                                        <?php if ($activityValue->source_url != ""): ?>
                                            通过 <a target="_blank" href="<?php echo $activityValue->source_url; ?>"><?php echo $source; ?></a>
                                        <?php endif; ?>
