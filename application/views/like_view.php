        ...
        <div class="left">
            <div class="right">
                <div class="mid">
                    ...
                    <div id="info"><label><?php echo $userDetails['name']; ?>喜欢的收藏</label></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="alpha" class="container Mcenter clearfix transitions-enabled">
                    ...
                    <?php if (($likeValue)): ?>
                        ...
                        <div class="pin_item" id="pin_item_<?php echo $likeValue->id; ?>">
                            ...
                            <div class="action">
                                ...
                                <span id="like_action<?php echo $likeValue->id; ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if (!isLiked($likeValue->id, $this->session->userdata('login_user_id'))): ?>
                                            <a class="act_like" id="<?php echo $likeId ?>" href="javascript:;"  onClick="doAction(<?php echo $like; ?>,<?php echo $likeValue->id; ?>,'like')"><span>喜欢</span></a>
                                        <?php else: ?>
                                            <a class="act_unlike" id="<?php echo $unlikeId ?>" href="javascript:;"   onClick="doAction(<?php echo $like; ?>,<?php echo $likeValue->id; ?>,'unlike')"><span>已喜欢</span></a>
                                        <?php endif ?>
                                    <?php endif ?>
                                </span>
                                ...
                                <a class="fancyboxForm act_repin ajax" href="<?php echo site_url('repin/load/' . $likeValue->id) ?>">收藏</a>
            ...
            <!--                                    <a class="act_comment" id="<?php //echo $commentId ?>" href="javascript:;" onClick="addComment(<?php //echo $likeValue->id; ?>,'comment')" ><span>Comment</span></a>
                            ...
                            <div class="comm_des">
                                ...
                                <p class="comm_like">
                                    ...
                                    <span id="<?php echo $likeCountId; ?>"><?php echo getPinLikeCount($likeValue->id); ?> 喜欢</span>
                            ...
                            <div class="convo_blk attribution">
                                ...
                                <p>
                                    ...
                                    <?php if ($likeValue->source_url != ""): ?>
                                        通过 <a target="_blank" href="<?php echo $likeValue->source_url; ?>"><?php echo $source; ?></a>
                                    <?php endif; ?>
            ...
            <?php else: ?>
                <div class="alert_messgae">
                    <h2 style="margin-left: 250px;">抱歉，没有找到。</h2>
                </div>
            <?php endif ?>
        </div> <!-- #alpha -->
